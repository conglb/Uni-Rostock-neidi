...
def example_data_processing():
    ...
    pm4data4sim.convert_csv_to_xes_activity(
        "data/S01.csv", 
        "results/S01.xes",
        case_id="Case_01",
    ...
    pm4data4sim.convert_csv_to_xes_activity_location(
    ...
    pm4data4sim.convert_csv_to_xes_all_subjects(
        "data/",
...
def example_mining():
    ...
    print("1. Alpha Miner...")
    net_alpha, marking_alpha = pm4data4sim.mine_process_alpha("results/S01.xes", "results/S01_alpha.pnml")
    
    # Example 2: Inductive Miner (replaces 12_initial_miner.py)
    print("2. Inductive Miner...")
    net_inductive, marking_inductive = pm4data4sim.mine_process_inductive("results/S01.xes", "results/S01_inductive.pnml")
    
    # Example 3: Heuristic Miner (replaces 18_heutistic-miner.py)
    print("3. Heuristic Miner...")
    net_heuristic, marking_heuristic = pm4data4sim.mine_process_heuristic("results/S01.xes", "results/S01_heuristic.pnml")
    
    # Example 4: High-level processes (replaces 17_initial miner_high-level_processes.py)
    print("4. High-level processes...")
    net_high, marking_high = pm4data4sim.mine_high_level_processes("results/S01.xes", "results/S01_high_level.pnml")
...
def example_visualization():
    ...
    pm4data4sim.visualize_petri_net("results/S01_inductive.pnml", "results/S01_basic.png")
    
    # Example 2: Without skip connections (replaces 26_visualize_without_skip_connections.py)
    print("2. Without skip connections...")
    pm4data4sim.visualize_petri_net_without_skip("results/S01_inductive.pnml", "results/S01_no_skip.png")
    
    # Example 3: BPMN visualization (replaces 22_pnml_to_bpmn_png.py)
    print("3. BPMN visualization...")
    pm4data4sim.visualize_bpmn("results/S01_inductive.pnml", "results/S01.bpmn")
    ...
    pm4data4sim.visualize_colored_petri_net("results/S01_inductive.pnml", "results/S01_colored.png", color_map)
...
def example_evaluation():
    ...
    fitness_token = pm4data4sim.check_fitness_token_replay("results/S01.xes", "results/S01_inductive.pnml")
    ...
    fitness_align = pm4data4sim.check_fitness_alignment("results/S01.xes", "results/S01_inductive.pnml")
    ...
    evaluation_results = pm4data4sim.evaluate_model("results/S01.xes", "results/S01_inductive.pnml")
    print(f"   Evaluation results: {evaluation_results}")
    
    # Example 4: Clustering (replaces 19_clustering.py)
    print("4. Process clustering...")
    pm4data4sim.cluster_processes("results/S01.xes", "results/clusters.json", num_clusters=3)
...
def example_high_level_process_detection():
    ...
    df_labeled = pm4data4sim.label_high_level_process(df)
    ...
    pm4data4sim.segment_high_level_process_by_fitness(
        "data/S01.csv",
...
def example_complete_workflow():
    ...
    pm4data4sim.convert_csv_to_xes_activity("data/S01.csv", "results/workflow_S01.xes")
    
    # Step 2: Mine process model (replaces 12_initial_miner.py)
    print("Step 2: Mining process model...")
    net, initial_marking, final_marking = pm4data4sim.mine_process_inductive("results/workflow_S01.xes", "results/workflow_S01.pnml")
    
    # Step 3: Visualize (replaces 20_output.py)
    print("Step 3: Visualizing...")
    pm4data4sim.visualize_petri_net("results/workflow_S01.pnml", "results/workflow_S01.png")
    
    # Step 4: Check fitness (replaces 33_scoring.py)
    print("Step 4: Checking fitness...")
    fitness = pm4data4sim.check_fitness_token_replay("results/workflow_S01.xes", "results/workflow_S01.pnml")
    ...
    pm4data4sim.convert_petri_net_to_graph("results/workflow_S01.pnml", "results/workflow_S01.gml")
    
    # Step 6: Analyze graph (replaces 61_graph_analysis.py)
    print("Step 6: Analyzing graph...")
    metrics = pm4data4sim.analyze_graph_structure("results/workflow_S01.gml")
    print(f"   Graph metrics: {metrics}")
